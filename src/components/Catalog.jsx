  ...
  return (
    <>
        <div className='flex xl:justify-end lg:justify-end mt-8'>
            ...
            <div className='grid lg:grid-cols-5 md:grid-cols-4 md:gap-4 sm:grid-cols-2  sm:gap-3  mt-5'>
                <div className='xl:col-end-3 lg:col-end-3'>
                    <img className ='sm:w-[49vw] w-[100vw]'src={Catalog1} alt='TutorialPic1'/>
                    <h6 className='mt-3 font-bold text-lg text-center'>Business branding</h6>
                </div>
