...
<div className='mt-20 flex justify-center '>
            <div className='  text-center  '>
                 ...
                 <p className='mt-3 text-center text-base font-sfRegular text-secondary-100'>Take a last look at your content and submit to get your idea designed
                </p>
            </div>
        </div>
        <div className='mt-20 flex justify-center'>
        <div className='  '>
            <form>
                ...
                <div className='mt-3'>
                        ...
                        <button className='ms-6 underline underline-offset-4 text-base font-sfRegular'>Change</button>
                </div>
                </div>

            <div className='mt-5 bg-light-200 rounded-lg px-5 py-2 w-[76vw] h-[38vh]'>
                <h3 className='mt-3 font-sfMedium text-xl'>Describe your design. </h3>
                <div className='mt-3'>
                        <input className='bg-light-200 px-5 py-2 w-[66vw] h-[18vh] ' type='text' maxLength={80}/>
                </div>
                <button className='mt-4 underline underline-offset-4 text-base font-sfRegular'>Edit</button>
            </div>
            ...
            <div className='bg-light-200 mt-4 rounded-lg pt-6 px-5 w-[76vw] h-[49vh]'>
