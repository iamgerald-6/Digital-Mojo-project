...
const handleChange = () => {
  ...
  <>
    <div className='relative '>
      ...
      <aside className=' bg-black absolute top-0 start-0 rounded-e-3xl w-[18vw] h-[135vh] lg:block hidden'>
          <div>
