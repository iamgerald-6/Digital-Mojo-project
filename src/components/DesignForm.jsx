    ...
    <>
         <div className='mt-28 flex justify-center '>
            <div className='  text-center  '>
                 ...
                 <p className='mt-3 text-center text-base font-sfRegular text-secondary-100'>Describe your design, add content and contacts, add inspiration from designs<br/>you love add brand colors and more 
                </p>
            </div>
        </div>
        ...
        <div className='  w-[70vw] flex  justify-center '>
            <form className=''>
                <div>
                    <h3 className='text-lg font-sfRegular'>1. Describe your design or explain the purpose of your design. </h3>
                    <div className='mt-3 '>
            ...
            <div className='mt-5 '>
                <div className='flex justify-between'>
                     ...
                     <Link to='/generate' className='flex text-sm font-sfRegular text-primary-500 mt-0.5 '><img className='w-[15px] h-[15px] mt-0.5 me-1' src={MagicPen} alt='Pen'/>Generate content</Link>
                </div>
            ...
            <div className='mt-5'>
                <h3 className='text-lg font-sfRegular text-dark-100'>6. Feature Images. </h3>
                <div className='mt-3 '>
