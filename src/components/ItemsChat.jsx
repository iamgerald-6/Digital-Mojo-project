    ...
    <>
                 ...
                 <div className='grid md:grid-cols-4 md:gap-4 sm:grid-cols-2  sm:gap-3   mt-5'>
                    <div  className=''>
                        ...
                        <h6 className='mt-1  text-base text-center font-semibold'>Beginner cyber security 101</h6>
                    ...
                    <div className=' '>
                        ...
                        <h6 className='mt-1 text-base text-center font-semibold'>Instagram growth</h6>
                    ...
                    <div className=''>
                        ...
                        <h6 className='mt-1 font-semibold text-center text-base'><Link to ='/intocourse' className='course-text-edit'>Facebook marketing</Link></h6>
                    ...
                    <div className=''>
                        ...
                        <div id={props.elementId}className='certified-container  mt-2 ms-2'><LuCrown className=''/><span className='ms-2'>Certified course</span></div>
                        <h6 className=' mt-1 text-base text-center font-semibold'>Social media marketing</h6>
